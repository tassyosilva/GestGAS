...
const Estoque: React.FC = () => {
    ...
    const botijasGas = itensEstoque.filter(item => item.categoria.includes('botija_gas'));
                    ...
                    <TableRow key={alerta.produto_id}>
                      ...
                      <TableCell align="right">
                        <Button
                          ...
                          color="primary"
                          onClick={() => {
                            const item = itensEstoque.find(i => i.produto_id === alerta.produto_id);
                            if (item) {
